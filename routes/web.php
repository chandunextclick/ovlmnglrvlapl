...
Route::group(['middleware' => ['auth', 'multi-company-select', 'email_verified'], 'prefix' => 'account'], function () {
    ...
    Route::match(['get', 'post'],'rankings/weeklytaskreport', [RankingsController::class, 'weeklytaskreport'])->name('rankings.weeklytaskreport');
    ...
    Route::post('rankings/getweeklytaskreport', [RankingsController::class, 'getweeklytaskreport'])->name('rankings.getweeklytask');
    ...
    Route::group(
        ...
        function () {
            ...
            Route::post('change-priority/{id}/{oper}', [ProjectController::class, 'changepriority'])->name('projects.change_priority');
    ...
    Route::group(['prefix' => 'tasks'], function () {
        ...
        Route::resource('task-result', TaskResultController::class);
    ...
    Route::post('project-report-chart', [ProjectReportController::class, 'projectChartData'])->name('project-report.chart');
    Route::resource('project-report', ProjectReportController::class);

    Route::post('employee-report-chart', [EmployeeReportController::class, 'taskChartData'])->name('employee-report.chart');
