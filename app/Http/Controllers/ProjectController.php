...
class ProjectController extends AccountBaseController
{
    ...
    public function changepriority($id,$oper)
    {
    ...
    public function create()
    {
        ...
        $this->shortcode = 'PRJ'.Project::max('id')+1;
    ...
    public function edit($id)
    {
        ...
        $this->projectteams=DB::select("SELECT * FROM project_departments pd,teams t where pd.team_id=t.id and pd.project_id='$id'");
    ...
    public function update(UpdateProject $request, $id)
    {
        ...
        if (!empty($request->team_id)) {
            ...
            DB::table('project_departments')->where('project_id', '=', $id)->delete();     
        ...
        if($request->has('task')){
            ...
            if ($projectTasks) {
                ...
                foreach ($projectTasks as $projectTask) {
                    ...
                    //added by chandu for add data to the added_by,last_updated_by,hash in task table on 04/09/2023
