...
class EmployeeController extends AccountBaseController
{
    ...
    public function create()
    {
        ...
        $this->lastEmployeeID = (int)EmployeeDetails::max('id');
    ...
    public function edit($id)
    {
        ...
        $this->employeememberdetail = DB::table('employee_member_details')->where('emp_id', $this->employee->employeeDetail->id)->get();
    ...
    public function employeeData($request, $employee): void
    {
        ...
        $employee->nomineerelation = $request->relation;
        $employee->nomineemobile = $request->guardianmobile;
        $employee->nomineeaadhar = $request->guardianaadhar;
        $employee->nomineeaddress = $request->guardianaddress;
