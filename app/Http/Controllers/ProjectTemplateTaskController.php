...
class ProjectTemplateTaskController extends AccountBaseController
{
    ...
    public function create(Request $request)
    {
        ...
        if ($completedTaskColumn) {
            ...
            $this->allTasks = ProjectTemplateTask::where('project_template_id', $this->project->id)->get();
        }
        else {  
            $this->allTasks = [];
        }
    ...
    public function edit($id)
    {
        ...
        $this->project = ProjectTemplate::with('projectMembers')->findOrFail($this->task->project_template_id);


        $this->employees = $this->project->projectMembers;

        $this->allTasks = ProjectTemplateTask::where('project_template_id', $this->task->project_template_id)->get();

        $this->dependenttask = ProjectTemplateTask::where('id',$this->task->dependent_task_id)->first();

        // var_dump($this->dependenttask);  
