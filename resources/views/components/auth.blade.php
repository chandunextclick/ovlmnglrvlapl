...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="https://lh3.googleusercontent.com/a-/ALV-UjXF4K2S5pNvCbV5fpBXX2NM56ienU7jjesL60zM0QOro_g=s48-p">
...
<header class="sticky-top d-flex justify-content-center align-items-center login_header bg-white px-4">
    <img class="mr-2 rounded" src="https://lh3.googleusercontent.com/a-/ALV-UjXF4K2S5pNvCbV5fpBXX2NM56ienU7jjesL60zM0QOro_g=s48-p" alt="Logo"/>
    @if ($globalSetting->sidebar_logo_style != 'full')
