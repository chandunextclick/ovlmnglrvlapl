...
<header class="main-header clearfix bg-white" id="header" style="margin-left:0;z-index:3;">

    <!-- NAVBAR LEFT(MOBILE MENU COLLAPSE) START-->
    <div class="navbar-left float-left d-flex align-items-center">
        <div class="logo-mini w-30">
				  <span class="light-logo"><img src="https://edoxi.cyradrive.com/assets/images/logo-letter.png" alt="logo" style="border-style:none;height:40px;max-width:100%;vertical-align:middle;margin-left:1rem;"></span>
				  <!-- <span class="dark-logo"><img src="https://edoxi.cyradrive.com/assets/images/logo-letter-white.png" alt="logo"></span> -->
			  </div>
			  <div class="logo-lg">
				  <span class="light-logo"><img src="https://edoxi.cyradrive.com/assets/images/logo-dark-text.png" alt="logo"></span>
				  <!-- <span class="dark-logo"><img src="https://edoxi.cyradrive.com/assets/images/logo-dark-text.png" alt="logo"></span> -->
			  </div>
			</a>	
		</div>  
        <div class="d-flex" style="align-items:center;height:100%;justify-content:right;padding:1rem;">
            <p class="f-15 text-info mb-0 font-weight-bold" data-placement="bottom" data-toggle="tooltip"
                                data-original-title="{{ mb_ucfirst(user()->name) }}">{{ mb_ucfirst(user()->name) }}</p>
            <span class="light-logo"><img src="https://lh3.googleusercontent.com/a-/ALV-UjXF4K2S5pNvCbV5fpBXX2NM56ienU7jjesL60zM0QOro_g=s48-p" alt="logo" style="border-style:none;height:40px;max-width:100%;margin:1rem;">
        </div>
