...
@foreach ($result['boardColumns'] as $key => $column)
    ...
    @else
        ...
        @if(($display == 'd-flex') && ($column->tasks_count == 0))
            <div class="board-panel rounded bg-additional-grey border-grey mr-3 d-none">
        @else
            <div class="board-panel rounded bg-additional-grey border-grey mr-3 d-block">
        @endif
            <!-- if block -->
            ...
            <div class="b-p-body">
                <!-- MAIN TASKS START -->
                <div class="b-p-tasks {{$display}}" id="drag-container-{{ $column->id }}" data-column-id="{{ $column->id }}">
                    <div
