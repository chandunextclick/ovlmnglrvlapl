...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="d-block d-lg-flex d-md-flex justify-content-between action-bar">
            ...
            <form method="POST" action="{{ route('rankings.monthlycountryranking')}}">
            @csrf
            <div class="d-flex">
    ...
    <table id="example" class="table table-striped table-responsive" style="min-height:100px;">
        ...
        ?>
            <tr>
                ...
                <td><input type="text" class="ranking" data-value="google_prev" data-id="<?=$value->id?>" value="<?=$value->google_rank_prev?>"></td>
            </tr>
...
var url = "{{ route('rankings.updatecountryrankings')}}";
