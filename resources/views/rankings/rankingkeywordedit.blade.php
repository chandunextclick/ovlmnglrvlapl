...
<div class="add-client bg-white rounded">
        <form method="POST" action="{{ route('rankings.rankinkeywordupdate') }}">
            @csrf
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    Edit Ranking Keywords</h4>
                <div class="row p-20">
                <div class="col-md-3">
                        ...
                        <select class="form-control height-35 f-14" placeholder="Course"  name="course_name" id="course_name"  required>
                            ...
                            <option {{($keyword->ranking_keyword == $course->id)?'selected':''}} value="{{$course->id}}">{{ $course->ranking_course }}</option>
                ...
                <div class="col-md-3">
                        ...
                        <select class="form-control height-35 f-14" placeholder="client"  name="client" id="client"  required>                 
                            <option <?= ($keyword->client == "EDOXI")? 'selected':'' ?> value="EDOXI">EDOXI</option>
                            <option <?= ($keyword->client == "TIMEMASTER")? 'selected':'' ?> value="TIMEMASTER">TIME MASTER</option>
                            <option <?= ($keyword->client == "TIMETRAINING")? 'selected':'' ?> value="TIMETRAINING">TIME TRAINING</option>                
                        </select>  
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control height-35 f-14" placeholder="Keyword Name" value="<?=$keyword->ranking_keyword?>" name="keyword_name" id="keyword_name" autocomplete="off" required>
                        <input type="hidden" class="form-control height-35 f-14" placeholder="Keyword ID" value="<?=$keyword->id?>" name="keyword_id" id="keyword_id" autocomplete="off" required>
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control height-35 f-14" placeholder="Search Volume" value="<?=$keyword->search_volume?>" name="search_volume" id="search_volume" autocomplete="off" >
                        </div>
