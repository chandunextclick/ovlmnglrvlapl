...
<div class="add-client bg-white rounded">
        <form method="POST" action="{{ route('rankings.rankincourseupdate') }}">
            @csrf
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    Edit Ranking Course</h4>
                <div class="row p-20">
                    <div class="col-md-4">
                        <div class="form-group">
                        <label class="f-14 text-dark-grey mb-12" data-label="true" for="course_name">Course Name
                        <sup class="f-14 mr-1">*</sup>
                        </label>
                        <input type="text" class="form-control height-35 f-14" placeholder="Course Name" value="<?=$courses->ranking_course?>" name="course_name" id="course_name" autocomplete="off" required>
                        <input type="hidden" class="form-control height-35 f-14" placeholder="Course Name" value="<?=$courses->id?>" name="course_id" id="course_id" autocomplete="off" required>
                    </div>
