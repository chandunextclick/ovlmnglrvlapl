...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="d-block d-lg-flex d-md-flex justify-content-between action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                ...
                <x-forms.link-primary :link="route('rankings.rankingcountrycreate')" class="mr-3 float-left" icon="plus">
                            @lang('app.add')
                            @lang('app.menu.rankingcountry')
    ...
    <table id="example" class="table table-striped table-responsive" style="min-height:100px;">
        ...
        <?php  
            ...
            foreach($rankingcountry as $value) 
            {  
        ...
        ?>
            <tr>
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="{{ route('rankings.rankincountryedit',['id' => $value->id])}}">Edit</a>
...
$(document).ready(function() {
    ...
    function deleterecord(id){
        ...
        var url = "{{ route('rankings.rankincountrydelete',':id')}}";
