...
<div class="add-client bg-white rounded">
        <form method="POST" action="{{ route('rankings.rankincoursestore') }}">
            @csrf
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    Add Ranking Course</h4>
                <div class="row p-20">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control height-35 f-14" placeholder="Course Name" value="" name="course_name" id="course_name" autocomplete="off" required>
                    </div>
