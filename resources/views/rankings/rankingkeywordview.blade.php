    ...
    <div class="content-wrapper">
        <div class="d-block d-lg-flex d-md-flex justify-content-between action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                ...
                <x-forms.link-primary :link="route('rankings.rankingkeywordcreate')" class="mr-3 float-left" icon="plus">
                            @lang('app.add')
                            @lang('app.menu.rankingkeyword')
        ...
        ?>
            <tr>
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="{{ route('rankings.rankinkeywordedit',['id' => $value->id])}}">Edit</a>
...
$(document).ready(function() {
    ...
    function deleterecord(id){
        ...
        var url = "{{ route('rankings.rankinkeyworddelete',':id')}}";
