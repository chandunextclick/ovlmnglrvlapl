        ...
        <x-form id="save-project-data-form">
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-lg-4 col-md-4 @if (!isset($client) && is_null($client)) py-3 @endif">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.taskShortCode')"
                                      fieldName="project_code"  fieldId="project_code"
                                      :fieldPlaceholder="__('placeholders.writeshortcode')" :fieldValue="$project ? $project->project_short_code : $shortcode"  :fieldReadOnly="true"/>
                    </div>
