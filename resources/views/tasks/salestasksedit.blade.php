...
<div class="add-client bg-white rounded">
        <form method="POST" action="{{ route('tasks.updsalestask') }}">
            @csrf
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    Update Sales Task</h4>
                <div class="row p-20">

                <div class="col-md-6">
                    <div class="form-group">
                    <label class="f-14 text-dark-grey mb-12" data-label="true" for="note_desc">Note Description
                    <sup class="f-14 mr-1">*</sup>
                    </label>
                    <textarea type="text" class="form-control f-14" rows="5" cols="10"  placeholder="Notes" name="tasknote"></textarea>
