                ...
                <div class="card-header bg-white  border-bottom-grey text-capitalize justify-content-between p-20">
                    <div class="row">
                        <div class="col-lg-8 col-10">
                            ...
                            || ($changeStatusPermission == 'added' && ($task->added_by == user()->id || in_array(user()->id,$headIds)))
                    ...
                    @endif
                        ...
                        @endif
                            ...
                            <div class="col-12 px-0 pb-3 d-lg-flex d-md-flex d-block">
                                <p class="mb-0 text-lightest f-14 w-30 text-capitalize">Result</p>
                    ...
                    <div class="s-b-inner s-b-notifications bg-white b-shadow-4 rounded">
                        ...
                        <x-tab-section class="task-tabs">
                            ...
                            @if (($taskSettings->files == 'yes' && in_array('client', user_roles())) || in_array('admin', user_roles()) || in_array('employee', user_roles()))
                                ...
                                <x-tab-item class="ajax-tab" :active="(request('view') === 'results')"
                                    :link="route('tasks.show', $task->id).'?view=results'">Result</x-tab-item>
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete-result', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        var url = "{{ route('task-result.destroy', ':id') }}";
                        url = url.replace(':id', id);
            ...
            $('body').on('click', '.edit-result', function() {
                var id = $(this).data('row-id');
                var url = "{{ route('task-result.edit', ':id') }}";
                url = url.replace(':id', id);
                $(MODAL_LG + ' ' + MODAL_HEADING).html('...');
                $.ajaxModal(MODAL_LG, url);
            });
